...
export const memoryRecords: MemoryRecord[] = [
  {
    ...
    content: 'Want to feel strong, not look thin. Being able to keep up on weekend hikes matters more than the scale.',
    tags: ['identity', 'energy', 'lifestyle'],
    confidence: 0.95,
  ...
  },
  {
    ...
    content: 'Heavy personal news this week. Three nights of takeout, no workouts. Member-shared, sealed to analyst view.',
    tags: ['personal_strain', 'high_cognitive_load', 'private'],
    confidence: 0.87,
...
export const patterns: Pattern[] = [
  {
    ...
    memberId: MAYA,
    summary:
      'Consistency drops sharply during high-load weeks (work travel, personal strain). Recovery is fast when the analyst softens tone and simplifies structure rather than pressing.',
